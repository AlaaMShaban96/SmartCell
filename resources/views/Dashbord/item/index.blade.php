...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
  ...
  <script>var items = @json($items,JSON_PRETTY_PRINT);</script>
    ...
    function formatProducts(products)
    {
        ...
        products.forEach(item => {
            ...
            item.forEach((ele,index) => {
                switch(index){
                    case 1:
                        product.productId = ele;
                        break;
                    case 0:
                        product.showProduct = ele;
                        break;
                    case 3:
                        product.title = ele;
                        break;
                    case 5:
                        product.subtitle = ele;
                        break;
                    case 4:
                        product.keywords = ele;
                        break;
                    case 28:
                        product.category = (ele == 1) ? true : false;
                        break;
                    case 6:
                        product.image = ele;
                        break;
            ...
            product.button1 = {type:"DATA",name:"Test",details:"test"};
